...
/***** module 0 start *****/
/***** src\pages\index.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n  <div class=\"content\">\n    <div class=\"bg-box\">\n      <img class=\"scan-img\" mode=\"scaleToFill\" style=\"width:100%;height:1350rpx\" src=\"pages/error.png\"/>\n    </div>\n    <div class=\"section form\" style=\"position:absolute;top:620rpx;left:5%\">\n        <form @submit=\"formSubmit($event)\" @reset=\"formReset($event)\">\n            <div class=\"form-input\" style=\"padding-top:36rpx\">\n                <div class=\"item\">\n                    <label>企业名称</label>\n                    <input name=\"companyName\" placeholder=\"请填写查询的企业名称\" placeholderClass=\"item-ph\" type=\"text\" @input=\"changeCompany($event)\" :value=\"(companyName)\"/>\n                </div>\n                <div class=\"item\">\n                    <label>联系人</label>\n                    <input name=\"name\" placeholder=\"请填写企业联系人\" placeholderClass=\"item-ph\" type=\"text\" @input=\"changeName($event)\" :value=\"(name)\"/>\n                </div>\n            </div>\n            <div>\n                <!-- <button class=\"go-look\" formType=\"submit\">查询</button> -->\n                <button formType=\"submit\" class=\"go-look\" v-if=\"(tel)\" :disabled=\"(disabled)\">查询</button>\n                <button open-type=\"getPhoneNumber\" @getphonenumber=\"getPhoneNumber($event)\"  wx:else=\"wx:else\" class=\"go-look\" :disabled=\"(disabled)\">查询</button>\n                <button formType=\"reset\" class=\"last-button\">清空</button>\n            </div>\n        </form>\n        <van-toast id=\"van-toast\"></van-toast>\n    </div>\n  </div>\n"},/***** module 0 end *****/
...
/***** module 2 start *****/
/***** src\pages\result.wpy *****/
function(module, exports, __wepy_require, process, global) {module.exports = "\n  <div style=\"width:95%;margin:auto\">\n    <div><span style=\"font-size:40rpx;display:flex;justify-content:center;margin-top:14rpx;padding-bottom:20rpx\">{{companyName}}</span></div>\n    <div><span style=\"font-size:36rpx;display:flex;justify-content:center;margin-top:14rpx;padding-bottom:20rpx\">税务异常信息</span></div>\n    <div class=\"table-container\">\n      <div class=\"table\">\n          <div class=\"tr\">\n              <div class=\"th td1\">税所</div>\n              <div class=\"th td2\">税种</div>\n              <div class=\"th td3\">所属期始</div>\n              <div class=\"th td4\">所属期止</div>\n          </div>\n          <div style=\"margin-top:40rpx\" v-if=\"(taxLoading)\">\n            <van-loading style=\"margin:45%\"></van-loading>\n            <div style=\"display:flex;justify-content:center;margin-top:14rpx;font-size: 24rpx;\">正在查询中...</div>\n          </div>\n          <div :wx:else=\"(taxLoading)\">\n            <div>\n              <div class=\"tr\" v-for=\"(index, item) in (taxErrorShow)\">\n                <div class=\"td td1\">{{item.gdslx}}</div>\n                <div class=\"td td2\">{{item.zsxmmc}}</div>\n                <div class=\"td td3\">{{item.skssqq}}</div>\n                <div class=\"td td4\">{{item.skssqz}}</div>\n              </div>\n            </div>\n            <div style=\"display:flex;justify-content:center;padding:16rpx\" @click=\"open_tax_more($event)\" v-if=\"(taxError.length > 5 &amp;&amp; !taxLoading &amp;&amp; (taxErrorShow.length == taxErrorFirst.length))\">点击查看更多</div>\n            <div style=\"display:flex;justify-content:center;padding:16rpx\" @click=\"close_tax_more($event)\" v-if=\"(taxError.length > 5 &amp;&amp; !taxLoading &amp;&amp; (taxErrorShow.length == taxError.length))\">点击关闭</div>\n            <div style=\"display:flex;justify-content:center;margin-top:14rpx\" v-if=\"(taxError.length == 0 &amp;&amp; !taxLoading)\">暂无异常</div>\n          </div>\n      </div>\n    </div>\n    <div><span style=\"font-size:36rpx;display:flex;justify-content:center;margin-top:14rpx;padding-bottom:20rpx\">工商异常信息</span></div>\n    <div style=\"margin-top:40rpx\" v-if=\"(businessLoading)\">\n      <van-loading style=\"margin:45%\"></van-loading>\n      <div style=\"display:flex;justify-content:center;margin-top:14rpx;font-size: 24rpx;\">正在查询中...</div>\n    </div>\n    <van-cell-group  wx:else=\"wx:else\">\n      <div v-for=\"(index, item) in (bussinessShow)\">\n        <van-cell title=\"列入经营异常名录原因\" :label=\"(item.abnormal_cause)\"></van-cell>\n        <van-cell title=\"决定机关\" :value=\"(item.office)\"></van-cell>\n        <van-cell title=\"列入日期\" :value=\"(item.abnormal_date)\"></van-cell>\n        <van-cell title=\"移出日期\" :value=\"(item.remove_date)\"></van-cell>\n      </div>\n    </van-cell-group>\n    <div style=\"display:flex;justify-content:center;padding:16rpx;font-size: 24rpx;\" @click=\"open_bussiness_more($event)\" v-if=\"(businessError.length > 1 &amp;&amp; !businessLoading &amp;&amp; (bussinessShow.length == bussinessFirst.length))\">点击查看更多</div>\n    <div style=\"display:flex;justify-content:center;padding:16rpx;font-size: 24rpx;\" @click=\"close_bussiness_more($event)\" v-if=\"(businessError.length > 1 &amp;&amp; !businessLoading &amp;&amp; (bussinessShow.length == businessError.length))\">点击关闭</div>\n    <div style=\"display:flex;justify-content:center;margin-top:14rpx;font-size: 24rpx;padding-top:24rpx;padding-bottom:24rpx\" v-if=\"(businessError.length == 0 &amp;&amp; !businessLoading)\">暂无异常</div>\n    <van-toast id=\"van-toast\"></van-toast>\n    <button @click=\"back($event)\" class=\"go-back\">返回</button>\n  </div>\n"},/***** module 2 end *****/
...
var _wepy = __wepy_require(5);

var _wepy2 = _interopRequireDefault(_wepy);

__wepy_require(6);

var _wepyRedux = __wepy_require(7);

var _store = __wepy_require(8);
...
var _default = function (_wepy$app) {
  ...
  function _default() {
    ...
    _this.config = {
      ...
      pages: ['pages/index', "pages/result"],
      window: {
...
__wepy_require(5).default.$createApp(_default, {"routes":{"pages/index":10,"pages/result":13},"style":[1,3,9],"components":{},"apis":{}}, {"noPromiseAPI":["createSelectorQuery"]});
...
var _app = __wepy_require(14);

var _app2 = _interopRequireDefault(_app);

var _page = __wepy_require(15);

var _page2 = _interopRequireDefault(_page);

var _component = __wepy_require(16);

var _component2 = _interopRequireDefault(_component);

var _event = __wepy_require(17);

var _event2 = _interopRequireDefault(_event);

var _base = __wepy_require(18);

var _base2 = _interopRequireDefault(_base);

var _util = __wepy_require(19);

var _util2 = _interopRequireDefault(_util);

var _mixin = __wepy_require(20);

var _mixin2 = _interopRequireDefault(_mixin);

var _wx = __wepy_require(21);
...
if (!g) {
  ...
  if (!g.Promise) {
    ...
    g.Promise = __wepy_require(23);
  }
  if (!g.regeneratorRuntime) {
    g.regeneratorRuntime = __wepy_require(24);
  }
}
...
var _connect = __wepy_require(25);

var _connect2 = _interopRequireDefault(_connect);

var _store = __wepy_require(26);

var _helpers = __wepy_require(27);
...
var _redux = __wepy_require(28);

var _reduxPromise = __wepy_require(29);

var _reduxPromise2 = _interopRequireDefault(_reduxPromise);

var _reducers = __wepy_require(30);
...
var _my_request = __wepy_require(11);

var _toast = __wepy_require(12);
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      formSubmit: function formSubmit(e) {
        ...
        for (var x in e.detail.value) {
          if (!e.detail.value[x]) {
            _toast2.default.fail("对不起，请补全信息！");
            return;
          } else {
            flag++;
          }
          if (flag == 2) {
            wx.setStorage({
              ...
              fail: function fail(e) {
                _toast2.default.fail("查询失败，请再来一次！");
              }
            });
          }
        }
      ...
      getPhoneNumber: function getPhoneNumber(e) {
        ...
        if (e.detail.encryptedData) {
          ...
          var url = 'user/weChatApplet/decodePhone';
          var config = {
          ...
          (0, _my_request.GET)(url, config, success, fail);
        } else {
          _toast2.default.fail("对不起，授权失败！");
        }
      }
...
var proUrl = "https://cloud.zgcfo.com/api/";
var devUrl = "http://cloud.yrl.fun/api/";
...
function GET(url, data, success) {
  var fail = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : fail;
  var complete = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : complete;
  var header = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : header;

  var baseUrl = devUrl + url;
...
/***** module 12 start *****/
/***** src\components\vant\toast\toast.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
var Index = function (_wepy$page) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      ...
      open_tax_more: function open_tax_more() {
        this.taxErrorShow = this.taxError;
      },
      close_tax_more: function close_tax_more() {
        this.taxErrorShow = this.taxErrorFirst;
      },
      open_bussiness_more: function open_bussiness_more() {
        this.bussinessShow = this.businessError;
      },
      close_bussiness_more: function close_bussiness_more() {
  ...
  _createClass(Index, [{
    ...
    value: function get_tax_error(e) {
      var _self = this;
      var url = 'customer/company/exception/etax';
      var config = {};
      ...
      function fail(err) {
        ...
        _toast2.default.fail("查询失败，请稍后重试！");
        // setTimeout(() => {
        //   wx.navigateBack("1")
        // }, 1500);
      }
      ...
      (0, _my_request.POST)(url, config, success, fail, complete, header);
    }
    ...
    key: 'get_bussiness',
    value: function get_bussiness(e) {
      var _self = this;
      var url = 'customer/company/exception/business';
      var config = {};
      config.companyName = e;
      ...
      function success(res) {
        ...
        for (var i = 0; i < _self.businessError.length; i++) {
...
var _component2 = __wepy_require(16);
...
var _createStore = __wepy_require(39);

var _createStore2 = _interopRequireDefault(_createStore);

var _combineReducers = __wepy_require(40);

var _combineReducers2 = _interopRequireDefault(_combineReducers);

var _bindActionCreators = __wepy_require(41);

var _bindActionCreators2 = _interopRequireDefault(_bindActionCreators);

var _applyMiddleware = __wepy_require(42);

var _applyMiddleware2 = _interopRequireDefault(_applyMiddleware);

var _compose = __wepy_require(43);

var _compose2 = _interopRequireDefault(_compose);

var _warning = __wepy_require(44);
...
var _fluxStandardAction = __wepy_require(45);
...
var _counter = __wepy_require(46);
...
/***** module 31 start *****/
/***** src\components\vant\common\utils.js *****/
function(module, exports, __wepy_require, process, global) {'use strict';
...
var _isPlainObject = __wepy_require(47);

var _isPlainObject2 = _interopRequireDefault(_isPlainObject);

var _symbolObservable = __wepy_require(48);
...
var _lodashIsplainobject = __wepy_require(49);
...
var _reduxActions = __wepy_require(50);

var _counter = __wepy_require(51);
...
function(module, exports, __wepy_require, process, global) {var baseGetTag = __wepy_require(52),
    getPrototype = __wepy_require(53),
    isObjectLike = __wepy_require(54);
...
var _ponyfill = __wepy_require(55);
 ...
 */
var baseFor = __wepy_require(56),
    isArguments = __wepy_require(57),
    keysIn = __wepy_require(58);
...
var _combineActions = _interopRequireDefault(__wepy_require(59));

exports.combineActions = _combineActions.default;

var _createAction = _interopRequireDefault(__wepy_require(60));

exports.createAction = _createAction.default;

var _createActions = _interopRequireDefault(__wepy_require(61));

exports.createActions = _createActions.default;

var _createCurriedAction = _interopRequireDefault(__wepy_require(62));

exports.createCurriedAction = _createCurriedAction.default;

var _handleAction = _interopRequireDefault(__wepy_require(63));

exports.handleAction = _handleAction.default;

var _handleActions = _interopRequireDefault(__wepy_require(64));
...
function(module, exports, __wepy_require, process, global) {var Symbol = __wepy_require(65),
    getRawTag = __wepy_require(66),
    objectToString = __wepy_require(67);
...
function(module, exports, __wepy_require, process, global) {var overArg = __wepy_require(68);
 ...
 * Available under MIT license <https://lodash.com/license>
 */
var isArguments = __wepy_require(57),
    isArray = __wepy_require(69);
...
var _invariant = _interopRequireDefault(__wepy_require(70));

var _isFunction = _interopRequireDefault(__wepy_require(71));

var _isSymbol = _interopRequireDefault(__wepy_require(72));

var _isEmpty = _interopRequireDefault(__wepy_require(73));

var _toString = _interopRequireDefault(__wepy_require(74));

var _isString = _interopRequireDefault(__wepy_require(75));

var _constants = __wepy_require(76);
...
var _identity = _interopRequireDefault(__wepy_require(77));

var _isNull = _interopRequireDefault(__wepy_require(78));
...
var _isPlainObject = _interopRequireDefault(__wepy_require(79));

var _isFunction = _interopRequireDefault(__wepy_require(71));

var _identity = _interopRequireDefault(__wepy_require(77));

var _isArray = _interopRequireDefault(__wepy_require(80));

var _isString = _interopRequireDefault(__wepy_require(75));

var _isNil = _interopRequireDefault(__wepy_require(81));

var _getLastElement = _interopRequireDefault(__wepy_require(82));

var _camelCase = _interopRequireDefault(__wepy_require(83));

var _arrayToObject = _interopRequireDefault(__wepy_require(84));

var _flattenActionMap = _interopRequireDefault(__wepy_require(85));

var _unflattenActionCreators = _interopRequireDefault(__wepy_require(86));
...
var _justCurryIt = _interopRequireDefault(__wepy_require(87));
...
var _isUndefined = _interopRequireDefault(__wepy_require(88));
...
var _reduceReducers = _interopRequireDefault(__wepy_require(89));

var _invariant = _interopRequireDefault(__wepy_require(70));

var _isPlainObject = _interopRequireDefault(__wepy_require(79));

var _isMap = _interopRequireDefault(__wepy_require(90));

var _ownKeys = _interopRequireDefault(__wepy_require(91));

var _flattenReducerMap = _interopRequireDefault(__wepy_require(92));

var _handleAction = _interopRequireDefault(__wepy_require(63));

var _get = _interopRequireDefault(__wepy_require(93));
...
function(module, exports, __wepy_require, process, global) {var root = __wepy_require(94);
...
var _toCamelCase = _interopRequireDefault(__wepy_require(95));
...
var _flattenWhenNode = _interopRequireDefault(__wepy_require(96));
...
var _hasGeneratorInterface = _interopRequireDefault(__wepy_require(97));
...
function(module, exports, __wepy_require, process, global) {var freeGlobal = __wepy_require(98);
